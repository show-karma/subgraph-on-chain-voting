...
export class UniswapGovernorBravo extends ethereum.SmartContract {
  static bind(address: Address): UniswapGovernorBravo {
    return new UniswapGovernorBravo("UniswapGovernorBravo", address);
  }
