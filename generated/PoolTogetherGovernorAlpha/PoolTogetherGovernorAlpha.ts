...
export class PoolTogetherGovernorAlpha__getActionsResult {
...
export class PoolTogetherGovernorAlpha__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class PoolTogetherGovernorAlpha__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class PoolTogetherGovernorAlpha extends ethereum.SmartContract {
  static bind(address: Address): PoolTogetherGovernorAlpha {
    return new PoolTogetherGovernorAlpha("PoolTogetherGovernorAlpha", address);
  }
  ...
  getActions(proposalId: BigInt): PoolTogetherGovernorAlpha__getActionsResult {
    let result = super.call(
      "getActions",
  ...
  try_getActions(
    ...
    return ethereum.CallResult.fromValue(
      new PoolTogetherGovernorAlpha__getActionsResult(
  ...
  proposals(param0: BigInt): PoolTogetherGovernorAlpha__proposalsResult {
    let result = super.call(
      "proposals",
  ...
  try_proposals(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new PoolTogetherGovernorAlpha__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
