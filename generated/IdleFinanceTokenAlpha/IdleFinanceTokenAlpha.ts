...
export class IdleFinanceTokenAlpha__getActionsResult {
...
export class IdleFinanceTokenAlpha__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class IdleFinanceTokenAlpha extends ethereum.SmartContract {
  static bind(address: Address): IdleFinanceTokenAlpha {
    return new IdleFinanceTokenAlpha("IdleFinanceTokenAlpha", address);
  }
  ...
  getActions(proposalId: BigInt): IdleFinanceTokenAlpha__getActionsResult {
    let result = super.call(
      "getActions",
  ...
  try_getActions(
    ...
    return ethereum.CallResult.fromValue(
      new IdleFinanceTokenAlpha__getActionsResult(
  ...
  proposals(param0: BigInt): IdleFinanceTokenAlpha__proposalsResult {
    let result = super.call(
      "proposals",
  ...
  try_proposals(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IdleFinanceTokenAlpha__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
