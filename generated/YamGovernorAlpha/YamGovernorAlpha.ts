...
export class YamGovernorAlpha__getActionsResult {
...
export class YamGovernorAlpha__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class YamGovernorAlpha__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class YamGovernorAlpha extends ethereum.SmartContract {
  static bind(address: Address): YamGovernorAlpha {
    return new YamGovernorAlpha("YamGovernorAlpha", address);
  }
  ...
  getActions(proposalId: BigInt): YamGovernorAlpha__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new YamGovernorAlpha__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<YamGovernorAlpha__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new YamGovernorAlpha__getActionsResult(
  ...
  getIncentivizers(): Array<Address> {
    let result = super.call(
      "getIncentivizers",
      "getIncentivizers():(address[])",
      []
    );
  ...
  try_getIncentivizers(): ethereum.CallResult<Array<Address>> {
    let result = super.tryCall(
      "getIncentivizers",
      "getIncentivizers():(address[])",
      []
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): YamGovernorAlpha__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<YamGovernorAlpha__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint256))",
      [
  ...
  incentivizers(param0: BigInt): Address {
    let result = super.call(
      "incentivizers",
      "incentivizers(uint256):(address)",
  ...
  try_incentivizers(param0: BigInt): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "incentivizers",
      "incentivizers(uint256):(address)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  proposals(param0: BigInt): YamGovernorAlpha__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new YamGovernorAlpha__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<YamGovernorAlpha__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new YamGovernorAlpha__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
...
export class ConstructorCall__Inputs {
  ...
  get incentivizers_(): Array<Address> {
...
export class AddIncentivizerCall extends ethereum.Call {
  get inputs(): AddIncentivizerCall__Inputs {
    return new AddIncentivizerCall__Inputs(this);
  }

  get outputs(): AddIncentivizerCall__Outputs {
    return new AddIncentivizerCall__Outputs(this);
  }
}

export class AddIncentivizerCall__Inputs {
  _call: AddIncentivizerCall;

  constructor(call: AddIncentivizerCall) {
    this._call = call;
  }

  get incentivizer(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}

export class AddIncentivizerCall__Outputs {
  _call: AddIncentivizerCall;
...
export class GetCurrentVotesCall extends ethereum.Call {
  get inputs(): GetCurrentVotesCall__Inputs {
    return new GetCurrentVotesCall__Inputs(this);
  }

  get outputs(): GetCurrentVotesCall__Outputs {
    return new GetCurrentVotesCall__Outputs(this);
  }
}

export class GetCurrentVotesCall__Inputs {
  _call: GetCurrentVotesCall;

  constructor(call: GetCurrentVotesCall) {
    this._call = call;
  }
...
export class GetCurrentVotesCall__Outputs {
  _call: GetCurrentVotesCall;
...
export class GetPriorVotesCall extends ethereum.Call {
  get inputs(): GetPriorVotesCall__Inputs {
    return new GetPriorVotesCall__Inputs(this);
  }

  get outputs(): GetPriorVotesCall__Outputs {
    return new GetPriorVotesCall__Outputs(this);
  }
}

export class GetPriorVotesCall__Inputs {
  _call: GetPriorVotesCall;

  constructor(call: GetPriorVotesCall) {
    this._call = call;
  }
...
export class GetPriorVotesCall__Outputs {
  _call: GetPriorVotesCall;
...
export class RemoveIncentivizerCall extends ethereum.Call {
  get inputs(): RemoveIncentivizerCall__Inputs {
    return new RemoveIncentivizerCall__Inputs(this);
  }

  get outputs(): RemoveIncentivizerCall__Outputs {
    return new RemoveIncentivizerCall__Outputs(this);
  }
}

export class RemoveIncentivizerCall__Inputs {
  _call: RemoveIncentivizerCall;

  constructor(call: RemoveIncentivizerCall) {
    this._call = call;
  }
...
export class RemoveIncentivizerCall__Outputs {
  _call: RemoveIncentivizerCall;
