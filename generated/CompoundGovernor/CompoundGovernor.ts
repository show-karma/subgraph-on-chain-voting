...
export class CompoundGovernor extends ethereum.SmartContract {
  static bind(address: Address): CompoundGovernor {
    return new CompoundGovernor("CompoundGovernor", address);
  }
