...
export class RariGovernorBravo__getActionsResult {
...
export class RariGovernorBravo__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class RariGovernorBravo__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class RariGovernorBravo extends ethereum.SmartContract {
  static bind(address: Address): RariGovernorBravo {
    return new RariGovernorBravo("RariGovernorBravo", address);
  }
  ...
  getActions(proposalId: BigInt): RariGovernorBravo__getActionsResult {
    let result = super.call(
      "getActions",
  ...
  try_getActions(
    ...
    return ethereum.CallResult.fromValue(
      new RariGovernorBravo__getActionsResult(
  ...
  proposals(param0: BigInt): RariGovernorBravo__proposalsResult {
    let result = super.call(
      "proposals",
  ...
  try_proposals(
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new RariGovernorBravo__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
