...
export class IndexedGovernorAlpha__getActionsResult {
...
export class IndexedGovernorAlpha__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class IndexedGovernorAlpha__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class IndexedGovernorAlpha extends ethereum.SmartContract {
  static bind(address: Address): IndexedGovernorAlpha {
    return new IndexedGovernorAlpha("IndexedGovernorAlpha", address);
  }
  ...
  getActions(proposalId: BigInt): IndexedGovernorAlpha__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new IndexedGovernorAlpha__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<IndexedGovernorAlpha__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new IndexedGovernorAlpha__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): IndexedGovernorAlpha__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return result[0].toTuple() as IndexedGovernorAlpha__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<IndexedGovernorAlpha__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as IndexedGovernorAlpha__getReceiptResultValue0Struct
    );
  }
  ...
  proposals(param0: BigInt): IndexedGovernorAlpha__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new IndexedGovernorAlpha__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<IndexedGovernorAlpha__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new IndexedGovernorAlpha__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
