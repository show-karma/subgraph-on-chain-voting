...
export class AmpleforthGovernorBravo extends ethereum.SmartContract {
  static bind(address: Address): AmpleforthGovernorBravo {
    return new AmpleforthGovernorBravo("AmpleforthGovernorBravo", address);
  }
