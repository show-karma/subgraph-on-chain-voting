...
export class UniswapGovernorAlpha__getActionsResult {
...
export class UniswapGovernorAlpha__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class UniswapGovernorAlpha__proposalsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class UniswapGovernorAlpha extends ethereum.SmartContract {
  static bind(address: Address): UniswapGovernorAlpha {
    return new UniswapGovernorAlpha("UniswapGovernorAlpha", address);
  }
  ...
  getActions(proposalId: BigInt): UniswapGovernorAlpha__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new UniswapGovernorAlpha__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<UniswapGovernorAlpha__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new UniswapGovernorAlpha__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): UniswapGovernorAlpha__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
  ...
  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<UniswapGovernorAlpha__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
  ...
  proposals(param0: BigInt): UniswapGovernorAlpha__proposalsResult {
    let result = super.call(
      "proposals",
    ...
    return new UniswapGovernorAlpha__proposalsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_proposals(
    param0: BigInt
  ): ethereum.CallResult<UniswapGovernorAlpha__proposalsResult> {
    let result = super.tryCall(
      "proposals",
      "proposals(uint256):(uint256,address,uint256,uint256,uint256,uint256,uint256,bool,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new UniswapGovernorAlpha__proposalsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
